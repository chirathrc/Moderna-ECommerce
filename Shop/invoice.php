...
<body class="inner_page invoice_page" onload="generatePDF(<?php echo ($orderID) ?>);">
                                ...
                                <div class="page_title">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 col-12 mt-md-0 mt-1">
                                            <a href="index.php"><Button class="d-flex justify-content-end btn btn-dark"
                                                    id="download">Home</Button></a>
...
<script>
    alert("Please Wait a While Untill Automaticly Redirect to Home page");
</script>