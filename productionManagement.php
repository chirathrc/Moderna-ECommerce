...
<head>
    ...
    <title>BELLE - Search Product</title>
                    ...
                    <div class="container-fluid " id="detailsSection2">
                        ...
                        <div class="row" id="detailsSerachProduction">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="row mb-5 input-container">
                                    <form class="form-inline  ">
                                        ...
                                        <button class="btn my-2 my-sm-0" onclick="productAdminSearch()"
                                            id="searchBUTTON">
                            ...
                            <div class="col-md-6 col-12 ">
                                ...
                                <div class="input-container">
                                    <label for="exampleInput" class="form-label">Discount (Optional)</label>
                                    <input type="number" class="form-control" id="exampleInput" placeholder="5%">
                                </div>
                                <div class="input-container">
                                    <label for="exampleInput" class="form-label">Product qty</label>
                                    <input type="number" class="form-control" id="exampleInput" placeholder="0">
                                </div>

                                <div class="input-container">
                                    <label for="exampleInput" class="form-label">Product Description (100 Words)</label>
                                    <Textarea id="textarea" class="form-control" rows="8" required></Textarea>
                                </div>
                                ...
                                <div class="row d-flex justify-content-center mt-4">
                                    <div class="col-6">
                                        <button class="form-control btn btn-success" disabled>Update</button>
                                    </div>
                                    <div class="col-6">
                                        <button class="form-control btn btn-success" onclick=""
