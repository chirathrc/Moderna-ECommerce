...
<head>
    ...
    <title>BELLE - Customer Managment</title>
    ...
    <link rel="icon" href="images/apple-touch-icon-114x114.pngtype" type="image/png" />
            ...
            <div id="content">
                ...
                <div class="midde_cont">
                    <div class="container-fluid">
                        ...
                        <div class="d-flex justify-content-center row mb-5">
                            <form class="form-inline col-12">
                                <input class="form-control mr-sm-4" type="search" placeholder="Search"
                                    aria-label="Search" id="CusName">
                                <button class="btn my-2 my-sm-0 " id="cusSearch">
                        ...
                        <div id="allCustomers" class="row column1">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="full white_shd margin_bottom_30" style="height: 230px;">
                                        ...
                                        <div class="info_people">
                                            ...
                                            <div class="p_info_img" data-toggle="modal" data-target="#exampleModalCenter"
                                            ...
                                            <div class="user_info_cont">
                                                ...
                                                <button type="button"
                                                    onclick="deactiVateCus('<?php echo ($employeeDataDetails['email']); ?>');"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="font-size: large;">
                                ...
                                <div class="m-1">
                                    ...
                                    <Label id="modalDate" class="text-success fw-bolder"></Label>
                                </div>
